      ...
      <section className="py-12 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-100">
            <img
              src={`${BASE}/images/city-port-elizabeth.png`}
              alt="SEO and Google Ads agency Port Elizabeth Gqeberha — Indexify helps Eastern Cape businesses rank on Google page 1"
