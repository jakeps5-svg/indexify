      ...
      <section className="py-12 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-100">
            <img
              src={`${BASE}/images/city-cape-town.png`}
              alt="SEO and Google Ads agency Cape Town — Indexify helps Cape Town businesses rank on Google page 1"
          ...
          <p className="text-center text-sm text-gray-400 mt-3">Real results from Indexify clients — Cape Town businesses ranking on page 1 of Google.</p>
        </div>
      </section>
