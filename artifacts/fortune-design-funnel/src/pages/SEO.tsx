...
const FAQS = [
  ...
  { q: "What makes Indexify different from other SEO agencies?", a: "We only focus on search marketing — no social media, no graphic design, no distractions. That singular focus means deeper expertise, faster results, and a team that genuinely understands how Google works at a technical level." },
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid md:grid-cols-2 gap-6">
            {[
              { text: "Thanks to Indexify's SEO strategy, Rapple is now ranking on Page 1 of Google for all our main keywords. Organic traffic has more than doubled and the quality of leads coming through search has been exceptional. Highly recommend.", author: "Leon De Wet", role: "Rapple Products", stars: 5 },
              { text: "Indexify's SEO work has completely changed our online presence. We are now ranking on page 1 for our most important search terms and the leads coming through Google have grown steadily every month. Very happy with the results and the service.", author: "Michael", role: "Captuna Charters", stars: 5 },
              { text: "We are very impressed with the SEO results Indexify has delivered for Precision Gates. Our website now ranks on the first page of Google for our key search terms and we are getting more organic inquiries than ever before. Excellent work.", author: "Megan van Niekerk", role: "Precision Gates", stars: 5 },
              { text: "Indexify has provided outstanding service. Our Google ranking skyrocketed from virtually nowhere to one of the top positions, and we began receiving significantly more inquiries almost immediately. Their team identified numerous gaps and errors that our previous SEO provider had missed. We highly recommend Indexify for anyone seeking expert Google optimization.", author: "Daniela Ciman", role: "Serenity Villa", stars: 5 },
            ].map((review, i) => (
