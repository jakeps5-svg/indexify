        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button 
              ...
              className="px-5 py-2.5 rounded-full bg-primary text-primary-foreground font-semibold text-sm hover:bg-primary/90 hover:scale-105 transition-all duration-200 shadow-[0_0_20px_rgba(245,158,11,0.3)]"
            >
              Get Free Audit
            </button>
          </div>
          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-4 flex flex-col">
              ...
              <div className="px-4 pt-2">
                <button 
                  onClick={() => scrollTo("contact")}
                  className="w-full px-5 py-3 rounded-xl bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-colors"
                >
                  Get Free Audit
                </button>
              </div>
